option(ENABLE_SAFETY "Enable full memory safety and debugging features" OFF)
...
if (ENABLE_SAFETY)
    string(APPEND BASE_COMPILER_FLAGS " -O0")
    string(APPEND BASE_COMPILER_FLAGS " -g3")
    string(APPEND BASE_COMPILER_FLAGS " -fno-omit-frame-pointer")
    string(APPEND BASE_COMPILER_FLAGS " -fno-optimize-sibling-calls")
    #string(APPEND BASE_COMPILER_FLAGS " -fsanitize=address")
    #string(APPEND BASE_COMPILER_FLAGS " -fsanitize=undefined")
    #string(APPEND BASE_COMPILER_FLAGS " -fsanitize=leak")
    string(APPEND BASE_COMPILER_FLAGS " -fno-sanitize-recover=all")
    string(APPEND BASE_COMPILER_FLAGS " -fstack-protector-all")


    set(BASE_LINKER_FLAGS "")
    #string(APPEND BASE_LINKER_FLAGS " -lasan")
    #string(APPEND BASE_LINKER_FLAGS " -fsanitize=address")
    #string(APPEND BASE_LINKER_FLAGS " -fsanitize=undefined")
    #string(APPEND BASE_LINKER_FLAGS " -fsanitize=leak")

    set(CMAKE_C_FLAGS_INIT "${BASE_COMPILER_FLAGS}")
    set(CMAKE_C_FLAGS_DEBUG_INIT "${BASE_COMPILER_FLAGS}")
    set(CMAKE_CXX_FLAGS_INIT "${BASE_COMPILER_FLAGS}")
    set(CMAKE_CXX_FLAGS_DEBUG_INIT "${BASE_COMPILER_FLAGS}")
    set(CMAKE_ASM_FLAGS_INIT "${BASE_COMPILER_FLAGS}")
    set(CMAKE_ASM_FLAGS_DEBUG_INIT "${BASE_COMPILER_FLAGS}")
...
message(STATUS "Compiling for ${TARGET_TRIPLE} with ${CMAKE_C_COMPILER} and safety enabled: ${ENABLE_SAFETY}")
